...
namespace NetSolutions.WebApi.Models.Validations
{
    /// <summary>
    /// Validates the maximum allowed file size in megabytes (MB) for an uploaded file.
    /// </summary>
    public class FileSizeMaxAttribute : ValidationAttribute
    {
        ...
        /// </summary>
        /// <param name="maxMegabytes">The maximum allowed file size in megabytes.</param>
        public FileSizeMaxAttribute(int maxMegabytes)
        {
            // Convert MB to bytes
